...
const items = [
  {
    ...
    children: (
      <div>
        <ul>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />What is node.js ?
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> A word on event loop
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Event driven architecture
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Blocking vs non-blocking code
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Setup node.js
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> The Node.js REPL
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> HelloWorld program
          </li>
        </ul>
      </div>
    ),
  },
  {
    ...
    children: (
      <div>
        <ul>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />  Understanding exports and require
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Creating modules
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />  Importing modules
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />  Quick tour on npm
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />   Installing 3rd party modules 
          </li>
        </ul>
      </div>
    ),
  },
  {
    ...
    children: (
      <div>
        <ul>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Significance of Events
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />  EventEmitter class
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Emitting and listening to events
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Types of streams
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Working with streams
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Composing streams using pipe
          </li>
        </ul>
      </div>
    ),
  },
  {
    ...
    children: (
      <div>
        <ul>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Process object
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Handling exceptions at process level
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Listening to processing events
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Working with file system using fs module
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Creating, Copying, deleting files
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Creating, Copying, deleting directories
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Watching for file changes
          </li>
        </ul>
      </div>
    ),
...
const items2 = [
  {
    key: "1",
    label:
      "What are prerequisites for learning Node JS Training?",
    children: (
      <div>
        <div className="border-l-4 border-[#49adcc] p-3 text-base pl-3 bg-[#49adcc8f]">
        Sufficient Knowledge in JavaScript. Basic Knowledge of HTTP, GET, POST, PUT, DELETE and REST Process and Basic Knowledge in Asynchronous Services are added advantages
        </div>
      </div>
    ),
  },
  {
    ...
    children: (
      <div>
        <div className="border-l-4 border-[#49adcc] p-3 text-base pl-3 bg-[#49adcc8f]">
        YES! You should have good knowledge in JavaScript. No worries, If you don’t have an idea in JavaScript, Here you can learn JavaScript too
        </div>
      </div>
    ),
  },
  {
    ...
    children: (
      <div>
        <div className="border-l-4 border-[#49adcc] p-3 text-base pl-3 bg-[#49adcc8f]">
        Node.js is an open source, cross-platform framework that runs on Windows, Linux, and Mac OS. The Node.js Training is designed to enable developers to understand and create web applications by making use of JavaScript
        </div>
      </div>
    ),
  },
  {
    ...
    children: (
      <div>
        <div className="border-l-4 border-[#49adcc] p-3 text-base pl-3 bg-[#49adcc8f]">
        The course gives you a platform where you can create web-based applications. Students who see themselves as future web developers can make use of this effective course
        </div>
      </div>
    ),
  },
    ...
    <div>
      ...
      <div className="section3">
        ...
        <div className="container m-auto p-6">
          ...
          KITKAT Software Technologies offers an exceptional{" "}
            ...
            Node.js is an open-source runtime environment that simplifies the development of server-side and networking applications. With its collection of libraries and JavaScript modules, Node.js allows for better performance and enables JavaScript to be used for server-side scripting. In this Node.js course in Coimbatore, you will learn the fundamentals and core concepts of Node.js, as well as the tools required for web application development.Whether you’re tackling challenges or developing web applications to meet business requirements, this course has you covered. Additionally, when it comes to iOS mobile application development, there are currently only around 20+ available devices on the market. With this limited variety, developers can create and test applications more efficiently.
          </div>
            ...
            <Row gutter={32} style={{ margin: 0 }}>
              <Col lg={12} md={12} sm={24} xs={24} className="mb-4">
                <div className="text-base">
                  ...
                  You will learn to understand the core concepts of the Node.js platform
                </div>
              </Col>
              <Col lg={12} md={12} sm={24} xs={24} className="mb-4">
                <div className="text-base">
      ...
      <div className="section4 bg-[#49adcc8f]">
        <div className="container m-auto p-6">
          ...
          This Node.js Certification course in Coimbatore is designed to give you an essence of front-end, middleware, and back-end web developer technologies. You will learn to build an end-to-end application, test and deploy code, store data and much more
          </div>
        </div>
      </div>
      ...
      <div className="section8 bg-[#49adcc8f]">
        <div className="container m-auto p-6">
          ...
          <div className="text-base text-center pb-4">
          Sufficient Knowledge in JavaScript is an added advantage. Basic concept Knowledge of HTTP, GET, POST, PUT, DELETE and REST Process, and Asynchronous Service are the prerequisites to learn the Node.js course in Coimbatore.
          </div>
        </div>
      </div>
