...
const items = [
  {
    ...
    children: (
      <div>
        <ul>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Variables & Constants

          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Introduction to functions (methods)
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Arrays, Dictionaries, Data, Date and other basic data types
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />  Enums, structures, closures
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> For, If, switch statements

          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Object oriented concepts with SWIFT

          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Type check, AnyObject, Any
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Protocols, Extensions, Error handling
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />  Working with classes
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> For, If, switch statements
          </li>
          ...
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Introduction to Multithreading
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Multithreading in iOS app, using NSThread, NSOperation and NSOperation
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Queue, GCD
          </li>
  ...
  },
  {
    ...
    children: (
      <div>
        <ul>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />  Introduction to XCODE
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> COCOA touch framework

          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />   iOS application architecture
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />   Application lifecycle
          </li>
  ...
  {
    key: "3",
    label: "View controllers and Views",
    children: (
      <div>
        <ul>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />View Controllers, view, view lifecycle
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />  Basic Controls – Label, Buttons, Text field, image View
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Table view & Collection view

          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Picker view, Date picker, scroll view, navigation and Tab bar controller

          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Understanding Interface builder
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Creating outlets and Actions
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Handling touch and gesture events

          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Segment and Page control, switch view, UIAlertView
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Using storyboard to design the app, using segues
          </li>
        </ul>
      </div>
    ),
  },
  {
    ...
    children: (
      <div>
        <ul>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Introduction to db
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Data storage methods in iOS
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Using Core Data, SQLite database
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> User Defaults, Property List
          </li>
  ...
  },
  {
    ...
    children: (
      <div>
        <ul>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Introduction to web services
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Different Types of web services
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />JSON parsing, XML parsing

          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Get and POST methods
          </li>
  ...
  },
  {
    ...
    children: (
      <div>
        <ul>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Playing Audio and Video
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Capturing images using camera

          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Getting images from gallery
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Sending mail and SMS from app
          </li>
  ...
  },
  {
    ...
    children: (
      <div>
        <ul>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Introduction to Auto-layout
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Working with constraints
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Using constraints to change view sizes
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Programmatically control the views
          </li>
  ...
  {
    key: "8",
    label: "Advanced Technologies ( Optional )",
    children: (
      <div>
        <ul>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Git/Bitbucket
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Vector Image
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Minimizing Size of IPA
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Trouble shooting & Debugging APP
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Third party integrations
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Push Notifications
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />  Map integration
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Google Firebase
          </li>
        </ul>
      </div>
    ),
    ...
    key: "9",
    label: "Launching An iOS app",
    children: (
      <div>
        <ul>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Introduction to BundleID, AppID, certificates

          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Making a build
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Posting app to App Store

          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Using TestFlight
          </li>
...
const items2 = [
  {
    ...
    children: (
      <div>
        ...
        iOS mobile applications are written in Swift or Objective C.
        </div>
      </div>
    ),
  },
  {
    key: "2",
    label: "Will I be given sufficient practical training in iOS?",
    children: (
      <div>
        <div className="border-l-4 border-[#49adcc] p-3 text-base pl-3 bg-[#49adcc8f]">
        We are designed to give a hands-on approach to the students in IOS. The course is made up of theoretical classes that teach the basics of each module followed by high-intensity practical sessions and needs of the industry that will demand the students’ time and commitment
        </div>
      </div>
    ),
  },
  {
    key: "3",
    label: "Why should I do iOS app training?",
    children: (
      <div>
        <div className="border-l-4 border-[#49adcc] p-3 text-base pl-3 bg-[#49adcc8f]">
        iOS is the world’s second most mobile operating system which helps you to get more job opportunities after completing your iOS training in Kitkat software Academy
        </div>
      </div>
    ),
  },
  {
    key: "4",
    label:
      "Will you provide placement assistance for me?",
    children: (
      <div>
        <div className="border-l-4 border-[#49adcc] p-3 text-base pl-3 bg-[#49adcc8f]">
        Yes, we provide a 100% placement assistance for our candidate for free from resume building to get you a job.
        </div>
      </div>
    ),
  },
  ...
  },
  {
    ...
    children: (
      <div>
        <div className="border-l-4 border-[#49adcc] p-3 text-base pl-3 bg-[#49adcc8f]">
        You will receive an iOS certification in the form of a course completion certificate.
        </div>
      </div>
    ),
  },
    ...
    <div>
            ...
            <Col lg={12} md={12} sm={24}>
              <div>
                <div className="text-3xl font-semibold">
                  ...
                  dedicated  iOS Course in Coimbatore.
                </div>
                <div className="mt-8 mb-12 text-base">
                Power your career with great iOS learning and specialize in Objective C, Swift Programming,OOPS, Xcode IDE & RealM Database.
                </div>
      ...
      <div className="section3">
        ...
        <div className="container m-auto p-6">
          ...
          Best IOS Development Course in Coimbatore
          </div>
          <div className="text-base">
           {" "}
            ...
            In this fast-moving world, technology evolves new changes to satisfy the needs of people. The scope of iOS development has a great future due to the growing demand for privacy. The Nschool Academy from Coimbatore provides the best iOS Development course in Coimbatore to hone your skills in the field of iOS development. KITKAT Software Technologics provides learner-friendly courses, from the fundamentals to the advanced level, that help you to get a high-paying job in the IT sector.
          </div>
          <div className="text-base mt-6">
          Our certified iOS app development course in Coimabtore provides a step-by-step guide that will support students develop their core skills and involve them in real-time issues and projects. Preparing for this IOS course will set you on the right approach to designing apps for iPads and iPhones. Our best ios training institute in Coimbatore learning outcomes Fundamentals of the Swift programming language, building great user interfaces with UIKit, prototyping an interface design, responsive design, advanced navigation in UIKit, creating a multi-screen app, interacting with hardware controls, location, and sensors, Data storage with Codable, Unit testing, Delivering to the App Store.
          </div>
        ...
        <div className="container m-auto p-6">
          ...
          <div className="text-base">
            {" "}
            <span className="font-semibold">
            The KITKAT Software Technologics covers the building blocks of iOS application development
            </span>{" "}
            ...
            <Row gutter={32} style={{ margin: 0 }}>
              <Col lg={12} md={12} sm={24} xs={24} className="mb-4">
                <div className="text-base">
                  ...
                  {/* <col lg={12} md={(12)} sm={24} xs={24} className="mb-4"></col> */}
              ...
              <Col lg={12} md={12} sm={24} xs={24} className="mb-4">
                <div className="text-base">
                  <span className="font-semibold">
                    ...
                    <h3>IOS Course Certification</h3><br></br>
                  </span>{" "}
                  A certificate ensures the recruiter that you are an expert in a particular domain. It accelerates your opportunity toward employment, builds professional credibility, and acts as an advanced option in your profession to get promoted to a better job. Our Best IOS training institute in Coimbatore provides developer-evaluated IOS Course certification in Coimbatore that passes you with flying colors in the interview.Job Assistance The Nschool provides the best support, from the preparation of interviews to getting landed on your dream job in your dream company under the guidance of professionals in the IOS development field.
                </div>
              </Col>
              <Col lg={8} md={8} sm={24} xs={12} className="">
                <div className="text-base">
                  <span className="font-semibold">
                   <h3>24*7 support</h3>
                  
                  </span>{" "}
                  The KITKAT Software Technologics, IOS training institute in Coimbatore, provides 24*7 support from our team of IOS development experts to the aspirants to get their queries sorted then and there, making the learners hassle-free learning
                </div>
              </Col>
      ...
      <div className="section4 bg-[#49adcc8f]">
        <div className="container m-auto p-6">
          <div className="text-center text-3xl font-semibold mt-4 mb-8">
          KITKAT Software Technologics iOS Development course in Coimbatore
          </div>
          <div className="text-base text-center pb-4">
          program provides extensive hands-on training in front-end, and back-end technology skills along with phase-end and capstone projects based on real business scenarios
          </div>
        </div>
      </div>
        ...
        <div className="container m-auto">
          <Row gutter={16} style={{ margin: 0 }} className="items-center">
            ...
            <Col lg={12} md={12} sm={24}>
              <div>
                <div className="text-base">
                KITKAT Software Technologics offer a comprehensive Node.js training program at a very affordable fee. Our flexible class timings cater to everyone’s schedule, and we even offer fast track and online training options for those who prefer a more intensive or remote learning experience. Our experienced industry trainers ensure that you not only grasp the theoretical concepts but also gain practical skills through hands-on exercises. Upon completion of the course, you will receive a course completion certificate for official recognition. Join us and master the art of writing code and building applications in Node.js!
                </div>
                <div className="mt-8">
      ...
      <div className="section7 bg-[#49adcc4a]">
        <div className="container m-auto p-6">
          <div className="text-center text-3xl font-semibold mt-4 mb-8">
          WHY NSCHOOL ACADEMY FOR NODE.JS TRAINING IN COIMBATORE?
          </div>
          <div className="text-base pb-4">
           {" "}
            ...
            Node.js Development program in Coimbatore provides extensive hands-on training in front-end, middleware, and back-end technology skills along with phase-end and capstone projects based on real business scenarios
          </div>
          <div className="mt-6">
      ...
      <div className="section8 bg-[#49adcc8f]">
        <div className="container m-auto p-6">
          ...
          <div className="text-base text-center pb-4">
          There are no technical requirements to join the IOS course in Coimbatore as the basic programming technologies are covered here.
          </div>
        </div>
      </div>
      <div className="section9 bg-[#1b424e] pt-8">
        <div className="container mx-auto md:px-6 xl:px-24">
          <section>
            ...
            Iphone mobile app development has been gaining popularity for quite some time and is currently in high-demand. iOS Development is an exciting career path for both freshers and experienced individuals
            </h2>
